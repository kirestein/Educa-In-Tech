...
### 2.15 Dashboards analíticos (fase 2)

Concluído:

- recorte por período adicionado ao dashboard via parâmetro `dias`;
- série recente de avaliações incluída no payload do dashboard;
- comparativo da turma com a coorte da mesma unidade/disciplina/ano letivo incluído;
...
### Prioridade 1 — Integrações externas
